    ...
    <div className="">
      {screenWidth > 768 ? (
        <div className="flex md:ml-[16%] h-screen">
          ...
          {selectedUser ? (
            <section className="w-full flex-1 border-l border-l-gray-300 flex flex-col h-full">
        ...
        <div className="flex md:ml-[16%] h-[90vh]">
                    ...
                    <div className="flex flex-col ">
                      <span
                        className={`font-medium ${
                          selectedUser && "hidden hover:block"
                        }`}
                      >
                        {suggestedUser?.username}
                      </span>
          ...
          {selectedUser ? (
            <section className="w-[90vw] flex-1 border-l border-l-gray-300 flex flex-col h-full">
              <div className="flex gap-3 items-center px-3 py-2 border-b border-gray-300 sticky top-0 bg-white z-10">
                <Avatar>
                  <AvatarImage src={selectedUser?.profilePicture} />
                  <AvatarFallback>TD</AvatarFallback>
